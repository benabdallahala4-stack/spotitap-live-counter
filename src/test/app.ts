...
type TestAppOptions = Omit<
  ServerOptions,
  'logger' | 'trustProxy' | 'adminToken' | 'provisioning' | 'woocommerceWebhookSecret'
> &
  Partial<
    Pick<ServerOptions, 'logger' | 'trustProxy' | 'adminToken' | 'provisioning' | 'woocommerceWebhookSecret'>
  >;
